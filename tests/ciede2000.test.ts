...
const CASES: Case[] = [
  ...
  { lab1: [50.0000, 3.1571, -77.2803], lab2: [50.0000, 0.0000, -82.7485], de: 2.8615 },
  { lab1: [50.0000, 2.8361, -74.0200], lab2: [50.0000, 0.0000, -82.7485], de: 3.4412 },
  { lab1: [50.0000, -1.3802, -84.2814], lab2: [50.0000, 0.0000, -82.7485], de: 1.0000 },
  { lab1: [50.0000, -1.1848, -84.8006], lab2: [50.0000, 0.0000, -82.7485], de: 1.0000 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [73.0000, 25.0000, -18.0000], de: 27.1492 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [61.0000, -5.0000, 29.0000], de: 22.8977 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [56.0000, -27.0000, -3.0000], de: 31.9030 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [58.0000, 24.0000, 15.0000], de: 19.4535 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [50.0000, 3.1736, 0.5854], de: 1.0000 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [50.0000, 3.2972, 0.0000], de: 1.0000 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [50.0000, 1.8634, 0.5757], de: 1.0000 },
  { lab1: [50.0000, 2.5000, 0.0000], lab2: [50.0000, 3.2592, 0.3350], de: 1.0000 },
  { lab1: [60.2574, -34.0099, 36.2677], lab2: [60.4626, -34.1751, 39.4387], de: 1.2644 },
  { lab1: [63.0109, -31.0961, -5.8663], lab2: [62.8187, -29.7946, -4.0864], de: 1.2630 },
  { lab1: [61.2901, 3.7196, -5.3901], lab2: [61.4292, 2.2480, -4.9620], de: 1.8731 },
  { lab1: [35.0831, -44.1164, 3.7933], lab2: [35.0232, -40.0716, 1.5901], de: 1.8645 },
  { lab1: [22.7233, 20.0904, -46.6940], lab2: [23.0331, 14.9730, -42.5619], de: 2.0373 },
  { lab1: [36.4612, 47.8580, 18.3852], lab2: [36.2715, 50.5065, 21.2231], de: 1.4146 },
  { lab1: [90.8027, -2.0831, 1.4410], lab2: [91.1528, -1.6435, 0.0447], de: 1.4441 },
  ...
  { lab1: [2.0776, 0.0795, -1.1350], lab2: [0.9033, -0.0636, -0.5514], de: 0.9082 },
]
...
describe('medoid palette colors', () => {
  it('palette colors are actual input colors, not washed-out means', () => {
    ...
    const members: [number, number, number][] = [
      [45, 70, 55], [45.5, 71, 54], [44.5, 69, 56], [45.2, 70.5, 55.2],
      [95, 2, 3], [94.8, 2.2, 2.8], [95.2, 1.8, 3.2], [94.9, 2.1, 2.9],
    ]
