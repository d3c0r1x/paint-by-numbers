...
export class ViewTransform {
  ...
  fitTo(containerW: number, containerH: number, contentW: number, contentH: number, padding = 24): void {
  ...
  applyPinch(start: { dist: number; mid: Point; scale: number; canvasPoint: Point }, nowDist: number, nowMid: Point): void {
